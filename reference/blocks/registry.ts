...
import { AboutOrganizationProfileCardCoverStatsTabs } from "./about-organization-profile-card-cover-stats-tabs";
...
import { AnalyticsKpiSummaryRowAreaChartBadge } from "./analytics-kpi-summary-row-area-chart-badge";
import { AnnouncementCenteredBadgeProductUpdateCard } from "./announcement-centered-badge-product-update-card";
...
import { ArticleSearchResultsCardsSnippetBadgeDate } from "./article-search-results-cards-snippet-badge-date";
...
import { ComparisonBilateralUsVsThemAdvantagesStark } from "./comparison-bilateral-us-vs-them-advantages-stark";
...
import { FaqAccordionSplitSupportCtaSidebar } from "./faq-accordion-split-support-cta-sidebar";
...
import { FeaturesAlternatingSplitImageBulletThreeRow } from "./features-alternating-split-image-bullet-three-row";
import { FeaturesBentoAsymmetricFlagshipMotionExpand } from "./features-bento-asymmetric-flagship-motion-expand";
import { FeaturesBentoGridSixCellSymmetric } from "./features-bento-grid-six-cell-symmetric";
...
import { GalleryGridUniformWithStatsSidebar } from "./gallery-grid-uniform-with-stats-sidebar";
...
import { GalleryMasonryCssColumnsCaptionHoverOverlay } from "./gallery-masonry-css-columns-caption-hover-overlay";
...
import { GalleryMasonryOffsetFramedDirectionalReveal } from "./gallery-masonry-offset-framed-directional-reveal";
...
import { LogoBentoFeaturedPartnerAsymmetricWithFrame } from "./logo-bento-featured-partner-asymmetric-with-frame";
...
import { NewsFeedActivityUpdatesVerticalRailDayGrouped } from "./news-feed-activity-updates-vertical-rail-day-grouped";
import { NewsReleaseLogSidebar } from "./news-release-log-sidebar";
import { OrganizationContactCard } from "./organization-contact-card";
import { OrganizationProfileCardMemberAvatarStack } from "./organization-profile-card-member-avatar-stack";
...
import { PricingCarouselFilmstripScaleActiveTier } from "./pricing-carousel-filmstrip-scale-active-tier";
...
import { PricingSingleSpotlightCenteredFeatured } from "./pricing-single-spotlight-centered-featured";
...
import { PricingThreeCardTiersHighlightedStandard } from "./pricing-three-card-tiers-highlighted-standard";
...
import { ProcessHowItWorksSimpleThreeHorizontal } from "./process-how-it-works-simple-three-horizontal";
import { ProcessHowItWorksVerticalBorderedRail } from "./process-how-it-works-vertical-bordered-rail";
import { ProcessHowItWorksVerticalFourSteps } from "./process-how-it-works-vertical-four-steps";
...
import { ProcessStepsHorizontalClickableInteractiveMobile } from "./process-steps-horizontal-clickable-interactive-mobile";
...
import { RealEstateHomepageHeroStatsServicesTestimonial } from "./real-estate-homepage-hero-stats-services-testimonial";
...
import { RoleDetailFullPageMetadataSectionsApplyCta } from "./role-detail-full-page-metadata-sections-apply-cta";
...
import { TestimonialsCarouselFramedAutoAdvanceSelectorBlur } from "./testimonials-carousel-framed-auto-advance-selector-blur";
...
import { TestimonialsFramedPanelGridCycleAvatarSelector } from "./testimonials-framed-panel-grid-cycle-avatar-selector";
...
import { TestimonialsMasonrySevenCardOrganicWall } from "./testimonials-masonry-seven-card-organic-wall";
...
import { TimelineVerticalMilestoneDatedBadges } from "./timeline-vertical-milestone-dated-badges";
...
export const blockSections: Record<string, ComponentType<{ ns: string }>> = {
  ...
  "about-organization-profile-card-cover-stats-tabs": AboutOrganizationProfileCardCoverStatsTabs,
  ...
  "analytics-kpi-summary-row-area-chart-badge": AnalyticsKpiSummaryRowAreaChartBadge,
  "announcement-centered-badge-product-update-card": AnnouncementCenteredBadgeProductUpdateCard,
  ...
  "article-search-results-cards-snippet-badge-date": ArticleSearchResultsCardsSnippetBadgeDate,
  ...
  "comparison-bilateral-us-vs-them-advantages-stark": ComparisonBilateralUsVsThemAdvantagesStark,
  ...
  "faq-accordion-split-support-cta-sidebar": FaqAccordionSplitSupportCtaSidebar,
  ...
  "features-alternating-split-image-bullet-three-row": FeaturesAlternatingSplitImageBulletThreeRow,
  "features-bento-asymmetric-flagship-motion-expand": FeaturesBentoAsymmetricFlagshipMotionExpand,
  "features-bento-grid-six-cell-symmetric": FeaturesBentoGridSixCellSymmetric,
  ...
  "gallery-grid-uniform-with-stats-sidebar": GalleryGridUniformWithStatsSidebar,
  ...
  "gallery-masonry-css-columns-caption-hover-overlay": GalleryMasonryCssColumnsCaptionHoverOverlay,
  ...
  "gallery-masonry-offset-framed-directional-reveal": GalleryMasonryOffsetFramedDirectionalReveal,
  ...
  "logo-bento-featured-partner-asymmetric-with-frame": LogoBentoFeaturedPartnerAsymmetricWithFrame,
  ...
  "news-feed-activity-updates-vertical-rail-day-grouped": NewsFeedActivityUpdatesVerticalRailDayGrouped,
  "news-release-log-sidebar": NewsReleaseLogSidebar,
  "organization-contact-card": OrganizationContactCard,
  "organization-profile-card-member-avatar-stack": OrganizationProfileCardMemberAvatarStack,
  ...
  "pricing-carousel-filmstrip-scale-active-tier": PricingCarouselFilmstripScaleActiveTier,
  ...
  "pricing-single-spotlight-centered-featured": PricingSingleSpotlightCenteredFeatured,
  ...
  "pricing-three-card-tiers-highlighted-standard": PricingThreeCardTiersHighlightedStandard,
  ...
  "process-how-it-works-simple-three-horizontal": ProcessHowItWorksSimpleThreeHorizontal,
  "process-how-it-works-vertical-bordered-rail": ProcessHowItWorksVerticalBorderedRail,
  "process-how-it-works-vertical-four-steps": ProcessHowItWorksVerticalFourSteps,
  ...
  "process-steps-horizontal-clickable-interactive-mobile": ProcessStepsHorizontalClickableInteractiveMobile,
  ...
  "real-estate-homepage-hero-stats-services-testimonial": RealEstateHomepageHeroStatsServicesTestimonial,
  ...
  "role-detail-full-page-metadata-sections-apply-cta": RoleDetailFullPageMetadataSectionsApplyCta,
  ...
  "testimonials-carousel-framed-auto-advance-selector-blur": TestimonialsCarouselFramedAutoAdvanceSelectorBlur,
  ...
  "testimonials-framed-panel-grid-cycle-avatar-selector": TestimonialsFramedPanelGridCycleAvatarSelector,
  ...
  "testimonials-masonry-seven-card-organic-wall": TestimonialsMasonrySevenCardOrganicWall,
  ...
  "timeline-vertical-milestone-dated-badges": TimelineVerticalMilestoneDatedBadges,
